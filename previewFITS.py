...
if __name__ == "__main__":
	...
	parser.add_argument('-s', '--save', type=str, help="Save the plot to a file.")
	...
	parser.add_argument('--headers', action="store_true", help="Dump all of the FITS headers to stdout.")
